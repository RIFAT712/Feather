...
| 2026-08-01 | Fixed review lock lifecycle: added an authenticated lock-release endpoint, release locks after accepted/rejected/skipped decisions, and release them when jurors skip, leave the review tab, switch articles, remove an article, or unmount the review page. |
